 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var P6;function pd(){if(P6)return wt;P6=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),C=Symbol.for("react.lazy"),A=Symbol.iterator;function R(N){return N===null||typeof N!="object"?null:(N=A&&N[A]||N["@@iterator"],typeof N=="function"?N:null)}var I={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},O=Object.assign,F={};function B(N,tt,ft){this.props=N,this.context=tt,this.refs=F,this.updater=ft||I}B.prototype.isReactComponent={},B.prototype.setState=function(N,tt){if(typeof N!="object"&&typeof N!="function"&&N!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,N,tt,"setState")},B.prototype.forceUpdate=function(N){this.updater.enqueueForceUpdate(this,N,"forceUpdate")};function $(){}$.prototype=B.prototype;function rt(N,tt,ft){this.props=N,this.context=tt,this.refs=F,this.updater=ft||I}var nt=rt.prototype=new $;nt.constructor=rt,O(nt,B.prototype),nt.isPureReactComponent=!0;var gt=Array.isArray,ht={H:null,A:null,T:null,S:null},Tt=Object.prototype.hasOwnProperty;function V(N,tt,ft,lt,ot,Rt){return ft=Rt.ref,{$$typeof:r,type:N,key:tt,ref:ft!==void 0?ft:null,props:Rt}}function b(N,tt){return V(N.type,tt,void 0,void 0,void 0,N.props)}function S(N){return typeof N=="object"&&N!==null&&N.$$typeof===r}function w(N){var tt={"=":"=0",":":"=2"};return"$"+N.replace(/[=:]/g,function(ft){return tt[ft]})}var x=/\/+/g;function k(N,tt){return typeof N=="object"&&N!==null&&N.key!=null?w(""+N.key):tt.toString(36)}function M(){}function xt(N){switch(N.status){case"fulfilled":return N.value;case"rejected":throw N.reason;default:switch(typeof N.status=="string"?N.then(M,M):(N.status="pending",N.then(function(tt){N.status==="pending"&&(N.status="fulfilled",N.value=tt)},function(tt){N.status==="pending"&&(N.status="rejected",N.reason=tt)})),N.status){case"fulfilled":return N.value;case"rejected":throw N.reason}}throw N}function Dt(N,tt,ft,lt,ot){var Rt=typeof N;(Rt==="undefined"||Rt==="boolean")&&(N=null);var bt=!1;if(N===null)bt=!0;else switch(Rt){case"bigint":case"string":case"number":bt=!0;break;case"object":switch(N.$$typeof){case r:case t:bt=!0;break;case C:return bt=N._init,Dt(bt(N._payload),tt,ft,lt,ot)}}if(bt)return ot=ot(N),bt=lt===""?"."+k(N,0):lt,gt(ot)?(ft="",bt!=null&&(ft=bt.replace(x,"$&/")+"/"),Dt(ot,tt,ft,"",function(ae){return ae})):ot!=null&&(S(ot)&&(ot=b(ot,ft+(ot.key==null||N&&N.key===ot.key?"":(""+ot.key).replace(x,"$&/")+"/")+bt)),tt.push(ot)),1;bt=0;var de=lt===""?".":lt+":";if(gt(N))for(var jt=0;jt<N.length;jt++)lt=N[jt],Rt=de+k(lt,jt),bt+=Dt(lt,tt,ft,Rt,ot);else if(jt=R(N),typeof jt=="function")for(N=jt.call(N),jt=0;!(lt=N.next()).done;)lt=lt.value,Rt=de+k(lt,jt++),bt+=Dt(lt,tt,ft,Rt,ot);else if(Rt==="object"){if(typeof N.then=="function")return Dt(xt(N),tt,ft,lt,ot);throw tt=String(N),Error("Objects are not valid as a React child (found: "+(tt==="[object Object]"?"object with keys {"+Object.keys(N).join(", ")+"}":tt)+"). If you meant to render a collection of children, use an array instead.")}return bt}function it(N,tt,ft){if(N==null)return N;var lt=[],ot=0;return Dt(N,lt,"","",function(Rt){return tt.call(ft,Rt,ot++)}),lt}function st(N){if(N._status===-1){var tt=N._result;tt=tt(),tt.then(function(ft){(N._status===0||N._status===-1)&&(N._status=1,N._result=ft)},function(ft){(N._status===0||N._status===-1)&&(N._status=2,N._result=ft)}),N._status===-1&&(N._status=0,N._result=tt)}if(N._status===1)return N._result.default;throw N._result}var K=typeof reportError=="function"?reportError:function(N){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var tt=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof N=="object"&&N!==null&&typeof N.message=="string"?String(N.message):String(N),error:N});if(!window.dispatchEvent(tt))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",N);return}console.error(N)};function Ct(){}return wt.Children={map:it,forEach:function(N,tt,ft){it(N,function(){tt.apply(this,arguments)},ft)},count:function(N){var tt=0;return it(N,function(){tt++}),tt},toArray:function(N){return it(N,function(tt){return tt})||[]},only:function(N){if(!S(N))throw Error("React.Children.only expected to receive a single React element child.");return N}},wt.Component=B,wt.Fragment=i,wt.Profiler=o,wt.PureComponent=rt,wt.StrictMode=s,wt.Suspense=p,wt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ht,wt.act=function(){throw Error("act(...) is not supported in production builds of React.")},wt.cache=function(N){return function(){return N.apply(null,arguments)}},wt.cloneElement=function(N,tt,ft){if(N==null)throw Error("The argument must be a React element, but you passed "+N+".");var lt=O({},N.props),ot=N.key,Rt=void 0;if(tt!=null)for(bt in tt.ref!==void 0&&(Rt=void 0),tt.key!==void 0&&(ot=""+tt.key),tt)!Tt.call(tt,bt)||bt==="key"||bt==="__self"||bt==="__source"||bt==="ref"&&tt.ref===void 0||(lt[bt]=tt[bt]);var bt=arguments.length-2;if(bt===1)lt.children=ft;else if(1<bt){for(var de=Array(bt),jt=0;jt<bt;jt++)de[jt]=arguments[jt+2];lt.children=de}return V(N.type,ot,void 0,void 0,Rt,lt)},wt.createContext=function(N){return N={$$typeof:f,_currentValue:N,_currentValue2:N,_threadCount:0,Provider:null,Consumer:null},N.Provider=N,N.Consumer={$$typeof:c,_context:N},N},wt.createElement=function(N,tt,ft){var lt,ot={},Rt=null;if(tt!=null)for(lt in tt.key!==void 0&&(Rt=""+tt.key),tt)Tt.call(tt,lt)&&lt!=="key"&&lt!=="__self"&&lt!=="__source"&&(ot[lt]=tt[lt]);var bt=arguments.length-2;if(bt===1)ot.children=ft;else if(1<bt){for(var de=Array(bt),jt=0;jt<bt;jt++)de[jt]=arguments[jt+2];ot.children=de}if(N&&N.defaultProps)for(lt in bt=N.defaultProps,bt)ot[lt]===void 0&&(ot[lt]=bt[lt]);return V(N,Rt,void 0,void 0,null,ot)},wt.createRef=function(){return{current:null}},wt.forwardRef=function(N){return{$$typeof:m,render:N}},wt.isValidElement=S,wt.lazy=function(N){return{$$typeof:C,_payload:{_status:-1,_result:N},_init:st}},wt.memo=function(N,tt){return{$$typeof:y,type:N,compare:tt===void 0?null:tt}},wt.startTransition=function(N){var tt=ht.T,ft={};ht.T=ft;try{var lt=N(),ot=ht.S;ot!==null&&ot(ft,lt),typeof lt=="object"&&lt!==null&&typeof lt.then=="function"&&lt.then(Ct,K)}catch(Rt){K(Rt)}finally{ht.T=tt}},wt.unstable_useCacheRefresh=function(){return ht.H.useCacheRefresh()},wt.use=function(N){return ht.H.use(N)},wt.useActionState=function(N,tt,ft){return ht.H.useActionState(N,tt,ft)},wt.useCallback=function(N,tt){return ht.H.useCallback(N,tt)},wt.useContext=function(N){return ht.H.useContext(N)},wt.useDebugValue=function(){},wt.useDeferredValue=function(N,tt){return ht.H.useDeferredValue(N,tt)},wt.useEffect=function(N,tt){return ht.H.useEffect(N,tt)},wt.useId=function(){return ht.H.useId()},wt.useImperativeHandle=function(N,tt,ft){return ht.H.useImperativeHandle(N,tt,ft)},wt.useInsertionEffect=function(N,tt){return ht.H.useInsertionEffect(N,tt)},wt.useLayoutEffect=function(N,tt){return ht.H.useLayoutEffect(N,tt)},wt.useMemo=function(N,tt){return ht.H.useMemo(N,tt)},wt.useOptimistic=function(N,tt){return ht.H.useOptimistic(N,tt)},wt.useReducer=function(N,tt,ft){return ht.H.useReducer(N,tt,ft)},wt.useRef=function(N){return ht.H.useRef(N)},wt.useState=function(N){return ht.H.useState(N)},wt.useSyncExternalStore=function(N,tt,ft){return ht.H.useSyncExternalStore(N,tt,ft)},wt.useTransition=function(){return ht.H.useTransition()},wt.version="19.0.0",wt}var B6;function G4(){return B6||(B6=1,i4.exports=pd()),i4.exports}var Q=G4();const li=yf(Q);var r4={exports:{}},ro={},a4={exports:{}},s4={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var j6;function gd(){return j6||(j6=1,function(r){function t(it,st){var K=it.length;it.push(st);t:for(;0<K;){var Ct=K-1>>>1,N=it[Ct];if(0<o(N,st))it[Ct]=st,it[K]=N,K=Ct;else break t}}function i(it){return it.length===0?null:it[0]}function s(it){if(it.length===0)return null;var st=it[0],K=it.pop();if(K!==st){it[0]=K;t:for(var Ct=0,N=it.length,tt=N>>>1;Ct<tt;){var ft=2*(Ct+1)-1,lt=it[ft],ot=ft+1,Rt=it[ot];if(0>o(lt,K))ot<N&&0>o(Rt,lt)?(it[Ct]=Rt,it[ot]=K,Ct=ot):(it[Ct]=lt,it[ft]=K,Ct=ft);else if(ot<N&&0>o(Rt,K))it[Ct]=Rt,it[ot]=K,Ct=ot;else break t}}return st}function o(it,st){var K=it.sortIndex-st.sortIndex;return K!==0?K:it.id-st.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var f=Date,m=f.now();r.unstable_now=function(){return f.now()-m}}var p=[],y=[],C=1,A=null,R=3,I=!1,O=!1,F=!1,B=typeof setTimeout=="function"?setTimeout:null,$=typeof clearTimeout=="function"?clearTimeout:null,rt=typeof setImmediate<"u"?setImmediate:null;function nt(it){for(var st=i(y);st!==null;){if(st.callback===null)s(y);else if(st.startTime<=it)s(y),st.sortIndex=st.expirationTime,t(p,st);else break;st=i(y)}}function gt(it){if(F=!1,nt(it),!O)if(i(p)!==null)O=!0,xt();else{var st=i(y);st!==null&&Dt(gt,st.startTime-it)}}var ht=!1,Tt=-1,V=5,b=-1;function S(){return!(r.unstable_now()-b<V)}function w(){if(ht){var it=r.unstable_now();b=it;var st=!0;try{t:{O=!1,F&&(F=!1,$(Tt),Tt=-1),I=!0;var K=R;try{e:{for(nt(it),A=i(p);A!==null&&!(A.expirationTime>it&&S());){var Ct=A.callback;if(typeof Ct=="function"){A.callback=null,R=A.priorityLevel;var N=Ct(A.expirationTime<=it);if(it=r.unstable_now(),typeof N=="function"){A.callback=N,nt(it),st=!0;break e}A===i(p)&&s(p),nt(it)}else s(p);A=i(p)}if(A!==null)st=!0;else{var tt=i(y);tt!==null&&Dt(gt,tt.startTime-it),st=!1}}break t}finally{A=null,R=K,I=!1}st=void 0}}finally{st?x():ht=!1}}}var x;if(typeof rt=="function")x=function(){rt(w)};else if(typeof MessageChannel<"u"){var k=new MessageChannel,M=k.port2;k.port1.onmessage=w,x=function(){M.postMessage(null)}}else x=function(){B(w,0)};function xt(){ht||(ht=!0,x())}function Dt(it,st){Tt=B(function(){it(r.unstable_now())},st)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(it){it.callback=null},r.unstable_continueExecution=function(){O||I||(O=!0,xt())},r.unstable_forceFrameRate=function(it){0>it||125<it?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):V=0<it?Math.floor(1e3/it):5},r.unstable_getCurrentPriorityLevel=function(){return R},r.unstable_getFirstCallbackNode=function(){return i(p)},r.unstable_next=function(it){switch(R){case 1:case 2:case 3:var st=3;break;default:st=R}var K=R;R=st;try{return it()}finally{R=K}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(it,st){switch(it){case 1:case 2:case 3:case 4:case 5:break;default:it=3}var K=R;R=it;try{return st()}finally{R=K}},r.unstable_scheduleCallback=function(it,st,K){var Ct=r.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?Ct+K:Ct):K=Ct,it){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=K+N,it={id:C++,callback:st,priorityLevel:it,startTime:K,expirationTime:N,sortIndex:-1},K>Ct?(it.sortIndex=K,t(y,it),i(p)===null&&it===i(y)&&(F?($(Tt),Tt=-1):F=!0,Dt(gt,K-Ct))):(it.sortIndex=N,t(p,it),O||I||(O=!0,xt())),it},r.unstable_shouldYield=S,r.unstable_wrapCallback=function(it){var st=R;return function(){var K=R;R=st;try{return it.apply(this,arguments)}finally{R=K}}}}(s4)),s4}var q6;function yd(){return q6||(q6=1,a4.exports=gd()),a4.exports}var l4={exports:{}},Fe={};/**
 * @license React
...
*/var Lr,f9;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(V,b){function S(){}S.prototype=b.prototype,V.D=b.prototype,V.prototype=new S,V.prototype.constructor=V,V.C=function(w,x,k){for(var M=Array(arguments.length-2),xt=2;xt<arguments.length;xt++)M[xt-2]=arguments[xt];return b.prototype[x].apply(w,M)}}function i(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}t(s,i),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(V,b,S){S||(S=0);var w=Array(16);if(typeof b=="string")for(var x=0;16>x;++x)w[x]=b.charCodeAt(S++)|b.charCodeAt(S++)<<8|b.charCodeAt(S++)<<16|b.charCodeAt(S++)<<24;else for(x=0;16>x;++x)w[x]=b[S++]|b[S++]<<8|b[S++]<<16|b[S++]<<24;b=V.g[0],S=V.g[1],x=V.g[2];var k=V.g[3],M=b+(k^S&(x^k))+w[0]+3614090360&4294967295;b=S+(M<<7&4294967295|M>>>25),M=k+(x^b&(S^x))+w[1]+3905402710&4294967295,k=b+(M<<12&4294967295|M>>>20),M=x+(S^k&(b^S))+w[2]+606105819&4294967295,x=k+(M<<17&4294967295|M>>>15),M=S+(b^x&(k^b))+w[3]+3250441966&4294967295,S=x+(M<<22&4294967295|M>>>10),M=b+(k^S&(x^k))+w[4]+4118548399&4294967295,b=S+(M<<7&4294967295|M>>>25),M=k+(x^b&(S^x))+w[5]+1200080426&4294967295,k=b+(M<<12&4294967295|M>>>20),M=x+(S^k&(b^S))+w[6]+2821735955&4294967295,x=k+(M<<17&4294967295|M>>>15),M=S+(b^x&(k^b))+w[7]+4249261313&4294967295,S=x+(M<<22&4294967295|M>>>10),M=b+(k^S&(x^k))+w[8]+1770035416&4294967295,b=S+(M<<7&4294967295|M>>>25),M=k+(x^b&(S^x))+w[9]+2336552879&4294967295,k=b+(M<<12&4294967295|M>>>20),M=x+(S^k&(b^S))+w[10]+4294925233&4294967295,x=k+(M<<17&4294967295|M>>>15),M=S+(b^x&(k^b))+w[11]+2304563134&4294967295,S=x+(M<<22&4294967295|M>>>10),M=b+(k^S&(x^k))+w[12]+1804603682&4294967295,b=S+(M<<7&4294967295|M>>>25),M=k+(x^b&(S^x))+w[13]+4254626195&4294967295,k=b+(M<<12&4294967295|M>>>20),M=x+(S^k&(b^S))+w[14]+2792965006&4294967295,x=k+(M<<17&4294967295|M>>>15),M=S+(b^x&(k^b))+w[15]+1236535329&4294967295,S=x+(M<<22&4294967295|M>>>10),M=b+(x^k&(S^x))+w[1]+4129170786&4294967295,b=S+(M<<5&4294967295|M>>>27),M=k+(S^x&(b^S))+w[6]+3225465664&4294967295,k=b+(M<<9&4294967295|M>>>23),M=x+(b^S&(k^b))+w[11]+643717713&4294967295,x=k+(M<<14&4294967295|M>>>18),M=S+(k^b&(x^k))+w[0]+3921069994&4294967295,S=x+(M<<20&4294967295|M>>>12),M=b+(x^k&(S^x))+w[5]+3593408605&4294967295,b=S+(M<<5&4294967295|M>>>27),M=k+(S^x&(b^S))+w[10]+38016083&4294967295,k=b+(M<<9&4294967295|M>>>23),M=x+(b^S&(k^b))+w[15]+3634488961&4294967295,x=k+(M<<14&4294967295|M>>>18),M=S+(k^b&(x^k))+w[4]+3889429448&4294967295,S=x+(M<<20&4294967295|M>>>12),M=b+(x^k&(S^x))+w[9]+568446438&4294967295,b=S+(M<<5&4294967295|M>>>27),M=k+(S^x&(b^S))+w[14]+3275163606&4294967295,k=b+(M<<9&4294967295|M>>>23),M=x+(b^S&(k^b))+w[3]+4107603335&4294967295,x=k+(M<<14&4294967295|M>>>18),M=S+(k^b&(x^k))+w[8]+1163531501&4294967295,S=x+(M<<20&4294967295|M>>>12),M=b+(x^k&(S^x))+w[13]+2850285829&4294967295,b=S+(M<<5&4294967295|M>>>27),M=k+(S^x&(b^S))+w[2]+4243563512&4294967295,k=b+(M<<9&4294967295|M>>>23),M=x+(b^S&(k^b))+w[7]+1735328473&4294967295,x=k+(M<<14&4294967295|M>>>18),M=S+(k^b&(x^k))+w[12]+2368359562&4294967295,S=x+(M<<20&4294967295|M>>>12),M=b+(S^x^k)+w[5]+4294588738&4294967295,b=S+(M<<4&4294967295|M>>>28),M=k+(b^S^x)+w[8]+2272392833&4294967295,k=b+(M<<11&4294967295|M>>>21),M=x+(k^b^S)+w[11]+1839030562&4294967295,x=k+(M<<16&4294967295|M>>>16),M=S+(x^k^b)+w[14]+4259657740&4294967295,S=x+(M<<23&4294967295|M>>>9),M=b+(S^x^k)+w[1]+2763975236&4294967295,b=S+(M<<4&4294967295|M>>>28),M=k+(b^S^x)+w[4]+1272893353&4294967295,k=b+(M<<11&4294967295|M>>>21),M=x+(k^b^S)+w[7]+4139469664&4294967295,x=k+(M<<16&4294967295|M>>>16),M=S+(x^k^b)+w[10]+3200236656&4294967295,S=x+(M<<23&4294967295|M>>>9),M=b+(S^x^k)+w[13]+681279174&4294967295,b=S+(M<<4&4294967295|M>>>28),M=k+(b^S^x)+w[0]+3936430074&4294967295,k=b+(M<<11&4294967295|M>>>21),M=x+(k^b^S)+w[3]+3572445317&4294967295,x=k+(M<<16&4294967295|M>>>16),M=S+(x^k^b)+w[6]+76029189&4294967295,S=x+(M<<23&4294967295|M>>>9),M=b+(S^x^k)+w[9]+3654602809&4294967295,b=S+(M<<4&4294967295|M>>>28),M=k+(b^S^x)+w[12]+3873151461&4294967295,k=b+(M<<11&4294967295|M>>>21),M=x+(k^b^S)+w[15]+530742520&4294967295,x=k+(M<<16&4294967295|M>>>16),M=S+(x^k^b)+w[2]+3299628645&4294967295,S=x+(M<<23&4294967295|M>>>9),M=b+(x^(S|~k))+w[0]+4096336452&4294967295,b=S+(M<<6&4294967295|M>>>26),M=k+(S^(b|~x))+w[7]+1126891415&4294967295,k=b+(M<<10&4294967295|M>>>22),M=x+(b^(k|~S))+w[14]+2878612391&4294967295,x=k+(M<<15&4294967295|M>>>17),M=S+(k^(x|~b))+w[5]+4237533241&4294967295,S=x+(M<<21&4294967295|M>>>11),M=b+(x^(S|~k))+w[12]+1700485571&4294967295,b=S+(M<<6&4294967295|M>>>26),M=k+(S^(b|~x))+w[3]+2399980690&4294967295,k=b+(M<<10&4294967295|M>>>22),M=x+(b^(k|~S))+w[10]+4293915773&4294967295,x=k+(M<<15&4294967295|M>>>17),M=S+(k^(x|~b))+w[1]+2240044497&4294967295,S=x+(M<<21&4294967295|M>>>11),M=b+(x^(S|~k))+w[8]+1873313359&4294967295,b=S+(M<<6&4294967295|M>>>26),M=k+(S^(b|~x))+w[15]+4264355552&4294967295,k=b+(M<<10&4294967295|M>>>22),M=x+(b^(k|~S))+w[6]+2734768916&4294967295,x=k+(M<<15&4294967295|M>>>17),M=S+(k^(x|~b))+w[13]+1309151649&4294967295,S=x+(M<<21&4294967295|M>>>11),M=b+(x^(S|~k))+w[4]+4149444226&4294967295,b=S+(M<<6&4294967295|M>>>26),M=k+(S^(b|~x))+w[11]+3174756917&4294967295,k=b+(M<<10&4294967295|M>>>22),M=x+(b^(k|~S))+w[2]+718787259&4294967295,x=k+(M<<15&4294967295|M>>>17),M=S+(k^(x|~b))+w[9]+3951481745&4294967295,V.g[0]=V.g[0]+b&4294967295,V.g[1]=V.g[1]+(x+(M<<21&4294967295|M>>>11))&4294967295,V.g[2]=V.g[2]+x&4294967295,V.g[3]=V.g[3]+k&4294967295}s.prototype.u=function(V,b){b===void 0&&(b=V.length);for(var S=b-this.blockSize,w=this.B,x=this.h,k=0;k<b;){if(x==0)for(;k<=S;)o(this,V,k),k+=this.blockSize;if(typeof V=="string"){for(;k<b;)if(w[x++]=V.charCodeAt(k++),x==this.blockSize){o(this,w),x=0;break}}else for(;k<b;)if(w[x++]=V[k++],x==this.blockSize){o(this,w),x=0;break}}this.h=x,this.o+=b},s.prototype.v=function(){var V=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);V[0]=128;for(var b=1;b<V.length-8;++b)V[b]=0;var S=8*this.o;for(b=V.length-8;b<V.length;++b)V[b]=S&255,S/=256;for(this.u(V),V=Array(16),b=S=0;4>b;++b)for(var w=0;32>w;w+=8)V[S++]=this.g[b]>>>w&255;return V};function c(V,b){var S=m;return Object.prototype.hasOwnProperty.call(S,V)?S[V]:S[V]=b(V)}function f(V,b){this.h=b;for(var S=[],w=!0,x=V.length-1;0<=x;x--){var k=V[x]|0;w&&k==b||(S[x]=k,w=!1)}this.g=S}var m={};function p(V){return-128<=V&&128>V?c(V,function(b){return new f([b|0],0>b?-1:0)}):new f([V|0],0>V?-1:0)}function y(V){if(isNaN(V)||!isFinite(V))return A;if(0>V)return B(y(-V));for(var b=[],S=1,w=0;V>=S;w++)b[w]=V/S|0,S*=4294967296;return new f(b,0)}function C(V,b){if(V.length==0)throw Error("number format error: empty string");if(b=b||10,2>b||36<b)throw Error("radix out of range: "+b);if(V.charAt(0)=="-")return B(C(V.substring(1),b));if(0<=V.indexOf("-"))throw Error('number format error: interior "-" character');for(var S=y(Math.pow(b,8)),w=A,x=0;x<V.length;x+=8){var k=Math.min(8,V.length-x),M=parseInt(V.substring(x,x+k),b);8>k?(k=y(Math.pow(b,k)),w=w.j(k).add(y(M))):(w=w.j(S),w=w.add(y(M)))}return w}var A=p(0),R=p(1),I=p(16777216);r=f.prototype,r.m=function(){if(F(this))return-B(this).m();for(var V=0,b=1,S=0;S<this.g.length;S++){var w=this.i(S);V+=(0<=w?w:4294967296+w)*b,b*=4294967296}return V},r.toString=function(V){if(V=V||10,2>V||36<V)throw Error("radix out of range: "+V);if(O(this))return"0";if(F(this))return"-"+B(this).toString(V);for(var b=y(Math.pow(V,6)),S=this,w="";;){var x=gt(S,b).g;S=$(S,x.j(b));var k=((0<S.g.length?S.g[0]:S.h)>>>0).toString(V);if(S=x,O(S))return k+w;for(;6>k.length;)k="0"+k;w=k+w}},r.i=function(V){return 0>V?0:V<this.g.length?this.g[V]:this.h};function O(V){if(V.h!=0)return!1;for(var b=0;b<V.g.length;b++)if(V.g[b]!=0)return!1;return!0}function F(V){return V.h==-1}r.l=function(V){return V=$(this,V),F(V)?-1:O(V)?0:1};function B(V){for(var b=V.g.length,S=[],w=0;w<b;w++)S[w]=~V.g[w];return new f(S,~V.h).add(R)}r.abs=function(){return F(this)?B(this):this},r.add=function(V){for(var b=Math.max(this.g.length,V.g.length),S=[],w=0,x=0;x<=b;x++){var k=w+(this.i(x)&65535)+(V.i(x)&65535),M=(k>>>16)+(this.i(x)>>>16)+(V.i(x)>>>16);w=M>>>16,k&=65535,M&=65535,S[x]=M<<16|k}return new f(S,S[S.length-1]&-2147483648?-1:0)};function $(V,b){return V.add(B(b))}r.j=function(V){if(O(this)||O(V))return A;if(F(this))return F(V)?B(this).j(B(V)):B(B(this).j(V));if(F(V))return B(this.j(B(V)));if(0>this.l(I)&&0>V.l(I))return y(this.m()*V.m());for(var b=this.g.length+V.g.length,S=[],w=0;w<2*b;w++)S[w]=0;for(w=0;w<this.g.length;w++)for(var x=0;x<V.g.length;x++){var k=this.i(w)>>>16,M=this.i(w)&65535,xt=V.i(x)>>>16,Dt=V.i(x)&65535;S[2*w+2*x]+=M*Dt,rt(S,2*w+2*x),S[2*w+2*x+1]+=k*Dt,rt(S,2*w+2*x+1),S[2*w+2*x+1]+=M*xt,rt(S,2*w+2*x+1),S[2*w+2*x+2]+=k*xt,rt(S,2*w+2*x+2)}for(w=0;w<b;w++)S[w]=S[2*w+1]<<16|S[2*w];for(w=b;w<2*b;w++)S[w]=0;return new f(S,0)};function rt(V,b){for(;(V[b]&65535)!=V[b];)V[b+1]+=V[b]>>>16,V[b]&=65535,b++}function nt(V,b){this.g=V,this.h=b}function gt(V,b){if(O(b))throw Error("division by zero");if(O(V))return new nt(A,A);if(F(V))return b=gt(B(V),b),new nt(B(b.g),B(b.h));if(F(b))return b=gt(V,B(b)),new nt(B(b.g),b.h);if(30<V.g.length){if(F(V)||F(b))throw Error("slowDivide_ only works with positive integers.");for(var S=R,w=b;0>=w.l(V);)S=ht(S),w=ht(w);var x=Tt(S,1),k=Tt(w,1);for(w=Tt(w,2),S=Tt(S,2);!O(w);){var M=k.add(w);0>=M.l(V)&&(x=x.add(S),k=M),w=Tt(w,1),S=Tt(S,1)}return b=$(V,x.j(b)),new nt(x,b)}for(x=A;0<=V.l(b);){for(S=Math.max(1,Math.floor(V.m()/b.m())),w=Math.ceil(Math.log(S)/Math.LN2),w=48>=w?1:Math.pow(2,w-48),k=y(S),M=k.j(b);F(M)||0<M.l(V);)S-=w,k=y(S),M=k.j(b);O(k)&&(k=R),x=x.add(k),V=$(V,M)}return new nt(x,V)}r.A=function(V){return gt(this,V).h},r.and=function(V){for(var b=Math.max(this.g.length,V.g.length),S=[],w=0;w<b;w++)S[w]=this.i(w)&V.i(w);return new f(S,this.h&V.h)},r.or=function(V){for(var b=Math.max(this.g.length,V.g.length),S=[],w=0;w<b;w++)S[w]=this.i(w)|V.i(w);return new f(S,this.h|V.h)},r.xor=function(V){for(var b=Math.max(this.g.length,V.g.length),S=[],w=0;w<b;w++)S[w]=this.i(w)^V.i(w);return new f(S,this.h^V.h)};function ht(V){for(var b=V.g.length+1,S=[],w=0;w<b;w++)S[w]=V.i(w)<<1|V.i(w-1)>>>31;return new f(S,V.h)}function Tt(V,b){var S=b>>5;b%=32;for(var w=V.g.length-S,x=[],k=0;k<w;k++)x[k]=0<b?V.i(k+S)>>>b|V.i(k+S+1)<<32-b:V.i(k+S);return new f(x,V.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,f9=s,f.prototype.add=f.prototype.add,f.prototype.multiply=f.prototype.j,f.prototype.modulo=f.prototype.A,f.prototype.compare=f.prototype.l,f.prototype.toNumber=f.prototype.m,f.prototype.toString=f.prototype.toString,f.prototype.getBits=f.prototype.i,f.fromNumber=y,f.fromString=C,Lr=f}).apply(typeof Eh<"u"?Eh:typeof self<"u"?self:typeof window<"u"?window:{});var tc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _t(r="Unexpected state"){const t=`FIRESTORE (${Ks}) INTERNAL ASSERTION FAILED: `+r;throw Yi(t),new Error(t)}function Qt(r,t){r||_t()}function St(r,t){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class O_{constructor(t,i,s,o){this.remoteDocumentCache=t,this.mutationQueue=i,this.documentOverlayCache=s,this.indexManager=o}getDocument(t,i){let s=null;return this.documentOverlayCache.getOverlay(t,i).next(o=>(s=o,this.remoteDocumentCache.getEntry(t,i))).next(o=>(s!==null&&po(s.mutation,o,pn.empty(),be.now()),o))}getDocuments(t,i){return this.remoteDocumentCache.getEntries(t,i).next(s=>this.getLocalViewOfDocuments(t,s,Nt()).next(()=>s))}getLocalViewOfDocuments(t,i,s=Nt()){const o=xa();return this.populateOverlays(t,o,i).next(()=>this.computeViews(t,i,o,s).next(c=>{let f=oo();return c.forEach((m,p)=>{f=f.insert(m,p.overlayedDocument)}),f}))}getOverlayedDocuments(t,i){const s=xa();return this.populateOverlays(t,s,i).next(()=>this.computeViews(t,i,s,Nt()))}populateOverlays(t,i,s){const o=[];return s.forEach(c=>{i.has(c)||o.push(c)}),this.documentOverlayCache.getOverlays(t,o).next(c=>{c.forEach((f,m)=>{i.set(f,m)})})}computeViews(t,i,s,o){let c=$i();const f=mo(),m=function(){return mo()}();return i.forEach((p,y)=>{const C=s.get(y.key);o.has(y.key)&&(C===void 0||C.mutation instanceof Xr)?c=c.insert(y.key,y):C!==void 0?(f.set(y.key,C.mutation.getFieldMask()),po(C.mutation,y,C.mutation.getFieldMask(),be.now())):f.set(y.key,pn.empty())}),this.recalculateAndSaveOverlays(t,c).next(p=>(p.forEach((y,C)=>f.set(y,C)),i.forEach((y,C)=>{var A;return m.set(y,new N_(C,(A=f.get(y))!==null&&A!==void 0?A:null))}),m))}recalculateAndSaveOverlays(t,i){const s=mo();let o=new re((f,m)=>f-m),c=Nt();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,i).next(f=>{for(const m of f)m.keys().forEach(p=>{const y=i.get(p);if(y===null)return;let C=s.get(p)||pn.empty();C=m.applyToLocalView(y,C),s.set(p,C);const A=(o.get(m.batchId)||Nt()).add(p);o=o.insert(m.batchId,A)})}).next(()=>{const f=[],m=o.getReverseIterator();for(;m.hasNext();){const p=m.getNext(),y=p.key,C=p.value,A=j9();C.forEach(R=>{if(!c.has(R)){const I=K9(i.get(R),s.get(R));I!==null&&A.set(R,I),c=c.add(R)}}),f.push(this.documentOverlayCache.saveOverlays(t,y,A))}return W.waitFor(f)}).next(()=>s)}recalculateAndSaveOverlaysForDocumentKeys(t,i){return this.remoteDocumentCache.getEntries(t,i).next(s=>this.recalculateAndSaveOverlays(t,s))}getDocumentsMatchingQuery(t,i,s,o){return function(f){return yt.isDocumentKey(f.path)&&f.collectionGroup===null&&f.filters.length===0}(i)?this.getDocumentsMatchingDocumentQuery(t,i.path):kv(i)?this.getDocumentsMatchingCollectionGroupQuery(t,i,s,o):this.getDocumentsMatchingCollectionQuery(t,i,s,o)}getNextDocuments(t,i,s,o){return this.remoteDocumentCache.getAllFromCollectionGroup(t,i,s,o).next(c=>{const f=o-c.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,i,s.largestBatchId,o-c.size):W.resolve(xa());let m=vo,p=c;return f.next(y=>W.forEach(y,(C,A)=>(m<A.largestBatchId&&(m=A.largestBatchId),c.get(C)?W.resolve():this.remoteDocumentCache.getEntry(t,C).next(R=>{p=p.insert(C,R)}))).next(()=>this.populateOverlays(t,y,c)).next(()=>this.computeViews(t,p,y,Nt())).next(C=>({batchId:m,changes:B9(C)})))})}getDocumentsMatchingDocumentQuery(t,i){return this.getDocument(t,new yt(i)).next(s=>{let o=oo();return s.isFoundDocument()&&(o=o.insert(s.key,s)),o})}getDocumentsMatchingCollectionGroupQuery(t,i,s,o){const c=i.collectionGroup;let f=oo();return this.indexManager.getCollectionParents(t,c).next(m=>W.forEach(m,p=>{const y=function(A,R){return new jc(R,null,A.explicitOrderBy.slice(),A.filters.slice(),A.limit,A.limitType,A.startAt,A.endAt)}(i,p.child(c));return this.getDocumentsMatchingCollectionQuery(t,y,s,o).next(C=>{C.forEach((A,R)=>{f=f.insert(A,R)})})}).next(()=>f))}getDocumentsMatchingCollectionQuery(t,i,s,o){let c;return this.documentOverlayCache.getOverlaysForCollection(t,i.path,s.largestBatchId).next(f=>(c=f,this.remoteDocumentCache.getDocumentsMatchingQuery(t,i,s,c,o))).next(f=>{c.forEach((p,y)=>{const C=y.getKey();f.get(C)===null&&(f=f.insert(C,Ke.newInvalidDocument(C)))});let m=oo();return f.forEach((p,y)=>{const C=c.get(p);C!==void 0&&po(C.mutation,y,pn.empty(),be.now()),Hc(i,y)&&(m=m.insert(p,y))}),m})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ge="WebChannelConnection";class aC extends iC{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}vo(t,i,s,o){const c=B4();return new Promise((f,m)=>{const p=new d9;p.setWithCredentials(!0),p.listenOnce(m9.COMPLETE,()=>{try{switch(p.getLastErrorCode()){case oc.NO_ERROR:const C=p.getResponseJson();ut(Ge,`XHR for RPC '${t}' ${c} received:`,JSON.stringify(C)),f(C);break;case oc.TIMEOUT:ut(Ge,`RPC '${t}' ${c} timed out`),m(new pt(et.DEADLINE_EXCEEDED,"Request time out"));break;case oc.HTTP_ERROR:const A=p.getStatus();if(ut(Ge,`RPC '${t}' ${c} failed with status:`,A,"response text:",p.getResponseText()),A>0){let R=p.getResponseJson();Array.isArray(R)&&(R=R[0]);const I=R==null?void 0:R.error;if(I&&I.status&&I.message){const O=function(B){const $=B.toLowerCase().replace(/_/g,"-");return Object.values(et).indexOf($)>=0?$:et.UNKNOWN}(I.status);m(new pt(O,I.message))}else m(new pt(et.UNKNOWN,"Server responded with status "+p.getStatus()))}else m(new pt(et.UNAVAILABLE,"Connection failed."));break;default:_t()}}finally{ut(Ge,`RPC '${t}' ${c} completed.`)}});const y=JSON.stringify(o);ut(Ge,`RPC '${t}' ${c} sending request:`,o),p.send(i,"POST",y,s,15)})}Wo(t,i,s){const o=B4(),c=[this.po,"/","google.firestore.v1.Firestore","/",t,"/channel"],f=y9(),m=g9(),p={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},y=this.longPollingOptions.timeoutSeconds;y!==void 0&&(p.longPollingTimeout=Math.round(1e3*y)),this.useFetchStreams&&(p.useFetchStreams=!0),this.Do(p.initMessageHeaders,i,s),p.encodeInitMessageHeaders=!0;const C=c.join("");ut(Ge,`Creating RPC '${t}' stream ${o}: ${C}`,p);const A=f.createWebChannel(C,p);let R=!1,I=!1;const O=new rC({Fo:B=>{I?ut(Ge,`Not sending because RPC '${t}' stream ${o} is closed:`,B):(R||(ut(Ge,`Opening RPC '${t}' stream ${o} transport.`),A.open(),R=!0),ut(Ge,`RPC '${t}' stream ${o} sending:`,B),A.send(B))},Mo:()=>A.close()}),F=(B,$,rt)=>{B.listen($,nt=>{try{rt(nt)}catch(gt){setTimeout(()=>{throw gt},0)}})};return F(A,lo.EventType.OPEN,()=>{I||(ut(Ge,`RPC '${t}' stream ${o} transport opened.`),O.Qo())}),F(A,lo.EventType.CLOSE,()=>{I||(I=!0,ut(Ge,`RPC '${t}' stream ${o} transport closed`),O.Ko())}),F(A,lo.EventType.ERROR,B=>{I||(I=!0,Ls(Ge,`RPC '${t}' stream ${o} transport errored:`,B),O.Ko(new pt(et.UNAVAILABLE,"The operation could not be completed")))}),F(A,lo.EventType.MESSAGE,B=>{var $;if(!I){const rt=B.data[0];Qt(!!rt);const nt=rt,gt=(nt==null?void 0:nt.error)||(($=nt[0])===null||$===void 0?void 0:$.error);if(gt){ut(Ge,`RPC '${t}' stream ${o} received error:`,gt);const ht=gt.status;let Tt=function(S){const w=ye[S];if(w!==void 0)return X9(w)}(ht),V=gt.message;Tt===void 0&&(Tt=et.INTERNAL,V="Unknown error status: "+ht+" with message "+gt.message),I=!0,O.Ko(new pt(Tt,V)),A.close()}else ut(Ge,`RPC '${t}' stream ${o} received:`,rt),O.Uo(rt)}}),F(m,p9.STAT_EVENT,B=>{B.stat===M4.PROXY?ut(Ge,`RPC '${t}' stream ${o} detected buffering proxy`):B.stat===M4.NOPROXY&&ut(Ge,`RPC '${t}' stream ${o} detected no buffering proxy`)}),setTimeout(()=>{O.$o()},0),O}}function _4(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class AC{constructor(){this.ea=void 0,this.ta=[]}na(){return this.ta.some(t=>t.ra())}}class SC{constructor(){this.queries=af(),this.onlineState="Unknown",this.ia=new Set}terminate(){(function(i,s){const o=St(i),c=o.queries;o.queries=af(),c.forEach((f,m)=>{for(const p of m.ta)p.onError(s)})})(this,new pt(et.ABORTED,"Firestore shutting down"))}}function af(){return new za(r=>L9(r),qc)}async function bC(r,t){const i=St(r);let s=3;const o=t.query;let c=i.queries.get(o);c?!c.na()&&t.ra()&&(s=2):(c=new AC,s=t.ra()?0:1);try{switch(s){case 0:c.ea=await i.onListen(o,!0);break;case 1:c.ea=await i.onListen(o,!1);break;case 2:await i.onFirstRemoteStoreListen(o)}}catch(f){const m=w2(f,`Initialization of query '${xs(t.query)}' failed`);return void t.onError(m)}i.queries.set(o,c),c.ta.push(t),t.sa(i.onlineState),c.ea&&t.oa(c.ea)&&R2(i)}async function wC(r,t){const i=St(r),s=t.query;let o=3;const c=i.queries.get(s);if(c){const f=c.ta.indexOf(t);f>=0&&(c.ta.splice(f,1),c.ta.length===0?o=t.ra()?0:1:!c.na()&&t.ra()&&(o=2))}switch(o){case 0:return i.queries.delete(s),i.onUnlisten(s,!0);case 1:return i.queries.delete(s),i.onUnlisten(s,!1);case 2:return i.onLastRemoteStoreUnlisten(s);default:return}}function RC(r,t){const i=St(r);let s=!1;for(const o of t){const c=o.query,f=i.queries.get(c);if(f){for(const m of f.ta)m.oa(o)&&(s=!0);f.ea=o}}s&&R2(i)}function DC(r,t,i){const s=St(r),o=s.queries.get(t);if(o)for(const c of o.ta)c.onError(i);s.queries.delete(t)}function R2(r){r.ia.forEach(t=>{t.next()})}var j4,sf;(sf=j4||(j4={}))._a="default",sf.Cache="cache";class MC{constructor(t,i,s){this.query=t,this.aa=i,this.ua=!1,this.ca=null,this.onlineState="Unknown",this.options=s||{}}oa(t){if(!this.options.includeMetadataChanges){const s=[];for(const o of t.docChanges)o.type!==3&&s.push(o);t=new Hs(t.query,t.docs,t.oldDocs,s,t.mutatedKeys,t.fromCache,t.syncStateChanged,!0,t.hasCachedResults)}let i=!1;return this.ua?this.la(t)&&(this.aa.next(t),i=!0):this.ha(t,this.onlineState)&&(this.Pa(t),i=!0),this.ca=t,i}onError(t){this.aa.error(t)}sa(t){this.onlineState=t;let i=!1;return this.ca&&!this.ua&&this.ha(this.ca,t)&&(this.Pa(this.ca),i=!0),i}ha(t,i){if(!t.fromCache||!this.ra())return!0;const s=i!=="Offline";return(!this.options.Ta||!s)&&(!t.docs.isEmpty()||t.hasCachedResults||i==="Offline")}la(t){if(t.docChanges.length>0)return!0;const i=this.ca&&this.ca.hasPendingWrites!==t.hasPendingWrites;return!(!t.syncStateChanged&&!i)&&this.options.includeMetadataChanges===!0}Pa(t){t=Hs.fromInitialDocuments(t.query,t.docs,t.mutatedKeys,t.fromCache,t.hasCachedResults),this.ua=!0,this.aa.next(t)}ra(){return this.options.source!==j4.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class v7{constructor(t){this.key=t}}class _7{constructor(t){this.key=t}}class IC{constructor(t,i){this.query=t,this.fa=i,this.ga=null,this.hasCachedResults=!1,this.current=!1,this.pa=Nt(),this.mutatedKeys=Nt(),this.ya=z9(t),this.wa=new ks(this.ya)}get ba(){return this.fa}Sa(t,i){const s=i?i.Da:new rf,o=i?i.wa:this.wa;let c=i?i.mutatedKeys:this.mutatedKeys,f=o,m=!1;const p=this.query.limitType==="F"&&o.size===this.query.limit?o.last():null,y=this.query.limitType==="L"&&o.size===this.query.limit?o.first():null;if(t.inorderTraversal((C,A)=>{const R=o.get(C),I=Hc(this.query,A)?A:null,O=!!R&&this.mutatedKeys.has(R.key),F=!!I&&(I.hasLocalMutations||this.mutatedKeys.has(I.key)&&I.hasCommittedMutations);let B=!1;R&&I?R.data.isEqual(I.data)?O!==F&&(s.track({type:3,doc:I}),B=!0):this.va(R,I)||(s.track({type:2,doc:I}),B=!0,(p&&this.ya(I,p)>0||y&&this.ya(I,y)<0)&&(m=!0)):!R&&I?(s.track({type:0,doc:I}),B=!0):R&&!I&&(s.track({type:1,doc:R}),B=!0,(p||y)&&(m=!0)),B&&(I?(f=f.add(I),c=F?c.add(C):c.delete(C)):(f=f.delete(C),c=c.delete(C)))}),this.query.limit!==null)for(;f.size>this.query.limit;){const C=this.query.limitType==="F"?f.last():f.first();f=f.delete(C.key),c=c.delete(C.key),s.track({type:1,doc:C})}return{wa:f,Da:s,ls:m,mutatedKeys:c}}va(t,i){return t.hasLocalMutations&&i.hasCommittedMutations&&!i.hasLocalMutations}applyChanges(t,i,s,o){const c=this.wa;this.wa=t.wa,this.mutatedKeys=t.mutatedKeys;const f=t.Da.X_();f.sort((C,A)=>function(I,O){const F=B=>{switch(B){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return _t()}};return F(I)-F(O)}(C.type,A.type)||this.ya(C.doc,A.doc)),this.Ca(s),o=o!=null&&o;const m=i&&!o?this.Fa():[],p=this.pa.size===0&&this.current&&!o?1:0,y=p!==this.ga;return this.ga=p,f.length!==0||y?{snapshot:new Hs(this.query,t.wa,c,f,t.mutatedKeys,p===0,y,!1,!!s&&s.resumeToken.approximateByteSize()>0),Ma:m}:{Ma:m}}sa(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({wa:this.wa,Da:new rf,mutatedKeys:this.mutatedKeys,ls:!1},!1)):{Ma:[]}}xa(t){return!this.fa.has(t)&&!!this.wa.has(t)&&!this.wa.get(t).hasLocalMutations}Ca(t){t&&(t.addedDocuments.forEach(i=>this.fa=this.fa.add(i)),t.modifiedDocuments.forEach(i=>{}),t.removedDocuments.forEach(i=>this.fa=this.fa.delete(i)),this.current=t.current)}Fa(){if(!this.current)return[];const t=this.pa;this.pa=Nt(),this.wa.forEach(s=>{this.xa(s.key)&&(this.pa=this.pa.add(s.key))});const i=[];return t.forEach(s=>{this.pa.has(s)||i.push(new _7(s))}),this.pa.forEach(s=>{t.has(s)||i.push(new v7(s))}),i}Oa(t){this.fa=t.gs,this.pa=Nt();const i=this.Sa(t.documents);return this.applyChanges(i,!0)}Na(){return Hs.fromInitialDocuments(this.query,this.wa,this.mutatedKeys,this.ga===0,this.hasCachedResults)}}const D2="SyncEngine";class xC{constructor(t,i,s){this.query=t,this.targetId=i,this.view=s}}class VC{constructor(t){this.key=t,this.Ba=!1}}class NC{constructor(t,i,s,o,c,f){this.localStore=t,this.remoteStore=i,this.eventManager=s,this.sharedClientState=o,this.currentUser=c,this.maxConcurrentLimboResolutions=f,this.La={},this.ka=new za(m=>L9(m),qc),this.qa=new Map,this.Qa=new Set,this.$a=new re(yt.comparator),this.Ka=new Map,this.Ua=new y2,this.Wa={},this.Ga=new Map,this.za=qs.Un(),this.onlineState="Unknown",this.ja=void 0}get isPrimaryClient(){return this.ja===!0}}async function OC(r,t,i=!0){const s=b7(r);let o;const c=s.ka.get(t);return c?(s.sharedClientState.addLocalQueryTarget(c.targetId),o=c.view.Na()):o=await C7(s,t,i,!0),o}async function kC(r,t){const i=b7(r);await C7(i,t,!0,!1)}async function C7(r,t,i,s){const o=await W_(r.localStore,ui(t)),c=o.targetId,f=r.sharedClientState.addLocalQueryTarget(c,i);let m;return s&&(m=await UC(r,t,c,f==="current",o.resumeToken)),r.isPrimaryClient&&i&&f7(r.remoteStore,o),m}async function UC(r,t,i,s,o){r.Ha=(A,R,I)=>async function(F,B,$,rt){let nt=B.view.Sa($);nt.ls&&(nt=await Zh(F.localStore,B.query,!1).then(({documents:V})=>B.view.Sa(V,nt)));const gt=rt&&rt.targetChanges.get(B.targetId),ht=rt&&rt.targetMismatches.get(B.targetId)!=null,Tt=B.view.applyChanges(nt,F.isPrimaryClient,gt,ht);return of(F,B.targetId,Tt.Ma),Tt.snapshot}(r,A,R,I);const c=await Zh(r.localStore,t,!0),f=new IC(t,c.gs),m=f.Sa(c.documents),p=Do.createSynthesizedTargetChangeForCurrentChange(i,s&&r.onlineState!=="Offline",o),y=f.applyChanges(m,r.isPrimaryClient,p);of(r,i,y.Ma);const C=new xC(t,i,f);return r.ka.set(t,C),r.qa.has(i)?r.qa.get(i).push(t):r.qa.set(i,[t]),y.snapshot}async function LC(r,t,i){const s=St(r),o=s.ka.get(t),c=s.qa.get(o.targetId);if(c.length>1)return s.qa.set(o.targetId,c.filter(f=>!qc(f,t))),void s.ka.delete(t);s.isPrimaryClient?(s.sharedClientState.removeLocalQueryTarget(o.targetId),s.sharedClientState.isActiveQueryTarget(o.targetId)||await P4(s.localStore,o.targetId,!1).then(()=>{s.sharedClientState.clearQueryState(o.targetId),i&&E2(s.remoteStore,o.targetId),q4(s,o.targetId)}).catch(Ys)):(q4(s,o.targetId),await P4(s.localStore,o.targetId,!0))}async function zC(r,t){const i=St(r),s=i.ka.get(t),o=i.qa.get(s.targetId);i.isPrimaryClient&&o.length===1&&(i.sharedClientState.removeLocalQueryTarget(s.targetId),E2(i.remoteStore,s.targetId))}async function PC(r,t,i){const s=QC(r);try{const o=await function(f,m){const p=St(f),y=be.now(),C=m.reduce((I,O)=>I.add(O.key),Nt());let A,R;return p.persistence.runTransaction("Locally write mutations","readwrite",I=>{let O=$i(),F=Nt();return p.ds.getEntries(I,C).next(B=>{O=B,O.forEach(($,rt)=>{rt.isValidDocument()||(F=F.add($))})}).next(()=>p.localDocuments.getOverlayedDocuments(I,O)).next(B=>{A=B;const $=[];for(const rt of m){const nt=Zv(rt,A.get(rt.key).overlayedDocument);nt!=null&&$.push(new Xr(rt.key,nt,M9(nt.value.mapValue),ci.exists(!0)))}return p.mutationQueue.addMutationBatch(I,y,$,m)}).next(B=>{R=B;const $=B.applyToLocalDocumentSet(A,F);return p.documentOverlayCache.saveOverlays(I,B.batchId,$)})}).then(()=>({batchId:R.batchId,changes:B9(A)}))}(s.localStore,t);s.sharedClientState.addPendingMutation(o.batchId),function(f,m,p){let y=f.Wa[f.currentUser.toKey()];y||(y=new re(kt)),y=y.insert(m,p),f.Wa[f.currentUser.toKey()]=y}(s,o.batchId,i),await Io(s,o.changes),await $c(s.remoteStore)}catch(o){const c=w2(o,"Failed to persist write");i.reject(c)}}async function E7(r,t){const i=St(r);try{const s=await $_(i.localStore,t);t.targetChanges.forEach((o,c)=>{const f=i.Ka.get(c);f&&(Qt(o.addedDocuments.size+o.modifiedDocuments.size+o.removedDocuments.size<=1),o.addedDocuments.size>0?f.Ba=!0:o.modifiedDocuments.size>0?Qt(f.Ba):o.removedDocuments.size>0&&(Qt(f.Ba),f.Ba=!1))}),await Io(i,s,t)}catch(s){await Ys(s)}}function lf(r,t,i){const s=St(r);if(s.isPrimaryClient&&i===0||!s.isPrimaryClient&&i===1){const o=[];s.ka.forEach((c,f)=>{const m=f.view.sa(t);m.snapshot&&o.push(m.snapshot)}),function(f,m){const p=St(f);p.onlineState=m;let y=!1;p.queries.forEach((C,A)=>{for(const R of A.ta)R.sa(m)&&(y=!0)}),y&&R2(p)}(s.eventManager,t),o.length&&s.La.p_(o),s.onlineState=t,s.isPrimaryClient&&s.sharedClientState.setOnlineState(t)}}async function BC(r,t,i){const s=St(r);s.sharedClientState.updateQueryState(t,"rejected",i);const o=s.Ka.get(t),c=o&&o.key;if(c){let f=new re(yt.comparator);f=f.insert(c,Ke.newNoDocument(c,Et.min()));const m=Nt().add(c),p=new Qc(Et.min(),new Map,new re(kt),f,m);await E7(s,p),s.$a=s.$a.remove(c),s.Ka.delete(t),M2(s)}else await P4(s.localStore,t,!1).then(()=>q4(s,t,i)).catch(Ys)}async function jC(r,t){const i=St(r),s=t.batch.batchId;try{const o=await Y_(i.localStore,t);A7(i,s,null),T7(i,s),i.sharedClientState.updateMutationState(s,"acknowledged"),await Io(i,o)}catch(o){await Ys(o)}}async function qC(r,t,i){const s=St(r);try{const o=await function(f,m){const p=St(f);return p.persistence.runTransaction("Reject batch","readwrite-primary",y=>{let C;return p.mutationQueue.lookupMutationBatch(y,m).next(A=>(Qt(A!==null),C=A.keys(),p.mutationQueue.removeMutationBatch(y,A))).next(()=>p.mutationQueue.performConsistencyCheck(y)).next(()=>p.documentOverlayCache.removeOverlaysForBatchId(y,C,m)).next(()=>p.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(y,C)).next(()=>p.localDocuments.getDocuments(y,C))})}(s.localStore,t);A7(s,t,i),T7(s,t),s.sharedClientState.updateMutationState(t,"rejected",i),await Io(s,o)}catch(o){await Ys(o)}}function T7(r,t){(r.Ga.get(t)||[]).forEach(i=>{i.resolve()}),r.Ga.delete(t)}function A7(r,t,i){const s=St(r);let o=s.Wa[s.currentUser.toKey()];if(o){const c=o.get(t);c&&(i?c.reject(i):c.resolve(),o=o.remove(t)),s.Wa[s.currentUser.toKey()]=o}}function q4(r,t,i=null){r.sharedClientState.removeLocalQueryTarget(t);for(const s of r.qa.get(t))r.ka.delete(s),i&&r.La.Ja(s,i);r.qa.delete(t),r.isPrimaryClient&&r.Ua.Sr(t).forEach(s=>{r.Ua.containsKey(s)||S7(r,s)})}function S7(r,t){r.Qa.delete(t.path.canonicalString());const i=r.$a.get(t);i!==null&&(E2(r.remoteStore,i),r.$a=r.$a.remove(t),r.Ka.delete(i),M2(r))}function of(r,t,i){for(const s of i)s instanceof v7?(r.Ua.addReference(s.key,t),HC(r,s)):s instanceof _7?(ut(D2,"Document no longer in limbo: "+s.key),r.Ua.removeReference(s.key,t),r.Ua.containsKey(s.key)||S7(r,s.key)):_t()}function HC(r,t){const i=t.key,s=i.path.canonicalString();r.$a.get(i)||r.Qa.has(s)||(ut(D2,"New document in limbo: "+i),r.Qa.add(s),M2(r))}function M2(r){for(;r.Qa.size>0&&r.$a.size<r.maxConcurrentLimboResolutions;){const t=r.Qa.values().next().value;r.Qa.delete(t);const i=new yt(Jt.fromString(t)),s=r.za.next();r.Ka.set(s,new VC(i)),r.$a=r.$a.insert(i,s),f7(r.remoteStore,new Or(ui(U9(i.path)),s,"TargetPurposeLimboResolution",zc.ae))}}async function Io(r,t,i){const s=St(r),o=[],c=[],f=[];s.ka.isEmpty()||(s.ka.forEach((m,p)=>{f.push(s.Ha(p,t,i).then(y=>{var C;if((y||i)&&s.isPrimaryClient){const A=y?!y.fromCache:(C=i==null?void 0:i.targetChanges.get(p.targetId))===null||C===void 0?void 0:C.current;s.sharedClientState.updateQueryState(p.targetId,A?"current":"not-current")}if(y){o.push(y);const A=_2.Yi(p.targetId,y);c.push(A)}}))}),await Promise.all(f),s.La.p_(o),await async function(p,y){const C=St(p);try{await C.persistence.runTransaction("notifyLocalViewChanges","readwrite",A=>W.forEach(y,R=>W.forEach(R.Hi,I=>C.persistence.referenceDelegate.addReference(A,R.targetId,I)).next(()=>W.forEach(R.Ji,I=>C.persistence.referenceDelegate.removeReference(A,R.targetId,I)))))}catch(A){if(!$s(A))throw A;ut(C2,"Failed to update sequence numbers: "+A)}for(const A of y){const R=A.targetId;if(!A.fromCache){const I=C.Ts.get(R),O=I.snapshotVersion,F=I.withLastLimboFreeSnapshotVersion(O);C.Ts=C.Ts.insert(R,F)}}}(s.localStore,c))}async function FC(r,t){const i=St(r);if(!i.currentUser.isEqual(t)){ut(D2,"User change. New user:",t.toKey());const s=await o7(i.localStore,t);i.currentUser=t,function(c,f){c.Ga.forEach(m=>{m.forEach(p=>{p.reject(new pt(et.CANCELLED,f))})}),c.Ga.clear()}(i,"'waitForPendingWrites' promise is rejected due to a user change."),i.sharedClientState.handleUserChange(t,s.removedBatchIds,s.addedBatchIds),await Io(i,s.Rs)}}function GC(r,t){const i=St(r),s=i.Ka.get(t);if(s&&s.Ba)return Nt().add(s.key);{let o=Nt();const c=i.qa.get(t);if(!c)return o;for(const f of c){const m=i.ka.get(f);o=o.unionWith(m.view.ba)}return o}}function b7(r){const t=St(r);return t.remoteStore.remoteSyncer.applyRemoteEvent=E7.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=GC.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=BC.bind(null,t),t.La.p_=RC.bind(null,t.eventManager),t.La.Ja=DC.bind(null,t.eventManager),t}function QC(r){const t=St(r);return t.remoteStore.remoteSyncer.applySuccessfulWrite=jC.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=qC.bind(null,t),t}class Mc{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=Kc(t.databaseInfo.databaseId),this.sharedClientState=this.Za(t),this.persistence=this.Xa(t),await this.persistence.start(),this.localStore=this.eu(t),this.gcScheduler=this.tu(t,this.localStore),this.indexBackfillerScheduler=this.nu(t,this.localStore)}tu(t,i){return null}nu(t,i){return null}eu(t){return K_(this.persistence,new F_,t.initialUser,this.serializer)}Xa(t){return new l7(v2.ri,this.serializer)}Za(t){return new tC}async terminate(){var t,i;(t=this.gcScheduler)===null||t===void 0||t.stop(),(i=this.indexBackfillerScheduler)===null||i===void 0||i.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Mc.provider={build:()=>new Mc};class KC extends Mc{constructor(t){super(),this.cacheSizeBytes=t}tu(t,i){Qt(this.persistence.referenceDelegate instanceof Rc);const s=this.persistence.referenceDelegate.garbageCollector;return new M_(s,t.asyncQueue,i)}Xa(t){const i=this.cacheSizeBytes!==void 0?an.withCacheSize(this.cacheSizeBytes):an.DEFAULT;return new l7(s=>Rc.ri(s,i),this.serializer)}}class H4{async initialize(t,i){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(i),this.remoteStore=this.createRemoteStore(i),this.eventManager=this.createEventManager(i),this.syncEngine=this.createSyncEngine(i,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=s=>lf(this.syncEngine,s,1),this.remoteStore.remoteSyncer.handleCredentialChange=FC.bind(null,this.syncEngine),await TC(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return function(){return new SC}()}createDatastore(t){const i=Kc(t.databaseInfo.databaseId),s=function(c){return new aC(c)}(t.databaseInfo);return function(c,f,m,p){return new uC(c,f,m,p)}(t.authCredentials,t.appCheckCredentials,s,i)}createRemoteStore(t){return function(s,o,c,f,m){return new hC(s,o,c,f,m)}(this.localStore,this.datastore,t.asyncQueue,i=>lf(this.syncEngine,i,0),function(){return tf.D()?new tf:new eC}())}createSyncEngine(t,i){return function(o,c,f,m,p,y,C){const A=new NC(o,c,f,m,p,y);return C&&(A.ja=!0),A}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,i)}async terminate(){var t,i;await async function(o){const c=St(o);ut(ka,"RemoteStore shutting down."),c.W_.add(5),await Mo(c),c.z_.shutdown(),c.j_.set("Unknown")}(this.remoteStore),(t=this.datastore)===null||t===void 0||t.terminate(),(i=this.eventManager)===null||i===void 0||i.terminate()}}H4.provider={build:()=>new H4};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
z"/>
        ...
        `),B=new Image;B.src=`data:image/svg+xml;charset=utf-8,${F}`,y.current=B;const $=()=>{const w=window.devicePixelRatio||1;p.current=w;const x=window.innerWidth,k=window.innerHeight;I.style.width=`${x}px`,I.style.height=`${k}px`,I.width=Math.round(x*w),I.height=Math.round(k*w),O.setTransform(w,0,0,w,0,0)},rt=()=>{const w=I.width/p.current,x=I.height/p.current,k=[];for(let M=0;M<r;M++){const xt=Math.random()*i+Math.random()*(i/2);k.push({x:Math.random()*w,y:Math.random()*x,r:xt,vx:(Math.random()-.5)*.6,vy:(.5+Math.random()*.9)*t,o:.5+Math.random()*.8,swing:Math.random()*20,phase:Math.random()*Math.PI*2})}m.current=k};let nt=performance.now();const gt=w=>{const x=(w-nt)/16.6667;nt=w;const k=I.width/p.current,M=I.height/p.current;O.clearRect(0,0,k,M);const xt=m.current;for(let st=0;st<xt.length;st++){const K=xt[st];K.phase+=.02*x,K.x+=K.vx*x+Math.sin(K.phase)*(K.swing*.01)*x,K.y+=K.vy*x,K.y-K.r>M&&(K.y=-K.r,K.x=Math.random()*k),K.x-K.r>k&&(K.x=-K.r),K.x+K.r<0&&(K.x=k+K.r),O.globalAlpha=K.o;const Ct=O.createRadialGradient(K.x,K.y,0,K.x,K.y,K.r*1.8);Ct.addColorStop(0,s),Ct.addColorStop(1,"rgba(255,255,255,0)"),O.fillStyle=Ct,O.beginPath(),O.arc(K.x,K.y,K.r,0,Math.PI*2),O.fill()}O.globalAlpha=1;const Dt=C.current;for(let st=Dt.length-1;st>=0;st--){const K=Dt[st];K.x+=K.vx*x;const Ct=Math.sin(w/400+K.x*.02)*6*K.scale,N=K.x,tt=K.y+Ct;y.current&&y.current.complete?(O.save(),O.translate(N,tt),K.dir===-1&&O.scale(-1,1),O.drawImage(y.current,-K.w/2,-K.h/2,K.w,K.h),O.restore()):(O.fillStyle="#e74c3c",O.fillRect(N-K.w/2,tt-K.h/2,K.w,K.h)),K.dir===1&&K.x-K.w/2>k+50&&Dt.splice(st,1),K.dir===-1&&K.x+K.w/2<-50&&Dt.splice(st,1)}const it=R.current;for(let st=it.length-1;st>=0;st--){const K=it[st];K.vy+=.06*x,K.vx*=.995,K.vy*=.999,K.x+=K.vx*x,K.y+=K.vy*x,K.life-=1*x;const Ct=Math.max(0,K.life/K.maxLife);O.globalAlpha=Ct;const N=O.createRadialGradient(K.x,K.y,0,K.x,K.y,K.r*2.5);N.addColorStop(0,K.color),N.addColorStop(.6,"rgba(255,255,255,0.2)"),N.addColorStop(1,"rgba(255,255,255,0)"),O.fillStyle=N,O.beginPath(),O.arc(K.x,K.y,K.r,0,Math.PI*2),O.fill(),K.life<=0&&it.splice(st,1)}O.globalAlpha=1,f.current=requestAnimationFrame(gt)},ht=()=>{const w=I.width/p.current,x=I.height/p.current,k=Math.random()>.5?1:-1,M=k===1?-60:w+60,xt=x*Math.random(),Dt=.6+Math.random()*.8,it=120,st=60,K=(2+Math.random()*2)*(k===1?1:-1)*Math.max(.5,t),Ct={x:M,y:xt,vx:K,scale:Dt,dir:k,w:it*Dt,h:st*Dt};C.current.push(Ct)},Tt=(w,x,k)=>{const M=30+Math.round(Math.random()*20),xt=[];for(let Dt=0;Dt<M;Dt++){const it=Math.random()*Math.PI*2,st=1+Math.random()*4,K=Math.cos(it)*st*(.6+Math.random()*1.4),Ct=Math.sin(it)*st*(.6+Math.random()*1.4)-Math.random()*1.5,N=1+Math.random()*3,tt=30+Math.random()*40,ft=k;xt.push({x:w,y:x,vx:K,vy:Ct,r:N,life:tt,maxLife:tt,color:ft})}R.current.push(...xt)},V=w=>{const x=I.getBoundingClientRect(),k=w.clientX-x.left,M=w.clientY-x.top,xt=C.current;for(let Dt=xt.length-1;Dt>=0;Dt--){const it=xt[Dt],st=k-it.x,K=M-it.y,Ct=Math.max(it.w,it.h)*.6;if(st*st+K*K<=Ct*Ct){Tt(it.x,it.y,"#ffb347"),xt.splice(Dt,1);break}}};$(),rt(),f.current=requestAnimationFrame(gt),A.current=window.setInterval(ht,5e3);const b=window.setTimeout(ht,1e3),S=()=>{$(),rt(),C.current=[]};return window.addEventListener("resize",S),window.addEventListener("click",V),()=>{f.current&&cancelAnimationFrame(f.current),A.current&&clearInterval(A.current),window.clearTimeout(b),window.removeEventListener("resize",S),window.removeEventListener("click",V)}},[r,t,i,s]),j.jsx("canvas",{ref:c,style:{position:"fixed",top:0,left:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:o},"aria-hidden":!0})}const NE=()=>j.jsxs("div",{className:"App",children:[j.jsx(xE,{}),j.jsx(VE,{}),j.jsx(Lm,{children:j.jsxs(mm,{children:[j.jsx(Nr,{path:"*",element:j.jsx(fm,{to:"/",replace:!0})}),j.jsx(Nr,{path:"/",element:j.jsx(J6,{})}),j.jsx(Nr,{path:"/greentrails/*",element:j.jsx(J6,{})}),j.jsx(Nr,{path:"/volenterpage/*",element:j.jsx(AE,{})}),j.jsx(Nr,{path:"/adddata/*",element:j.jsx(SE,{})}),j.jsx(Nr,{path:"/leaderboard/*",element:j.jsx(RE,{})}),j.jsx(Nr,{path:"/signup/*",element:j.jsx(ME,{})})]})})]});Ad.createRoot(document.getElementById("root")).render(j.jsx(li.StrictMode,{children:j.jsx(NE,{})}));
